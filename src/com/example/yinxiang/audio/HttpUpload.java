...
public class HttpUpload extends AsyncTask<Void, Integer, Void> {
    ...
    public HttpUpload(Context context, String url, String path) {
        super();
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            post.addHeader("X-AVOSCloud-Application-Id", "418dgirlkcy5pqph1tiuts5pxhdhjz4s3rft986mvevo73hi");
            post.addHeader("X-AVOSCloud-Application-Key", "r7cj4qp0t84ak240hdr9j62uqw6cv5qcl7og753c5lcp3pyp");
            ...
            String extension = MimeTypeMap.getFileExtensionFromUrl(Uri.fromFile(new File(imgPath)).toString());
            String mimeType = MimeTypeMap.getSingleton().getMimeTypeFromExtension(extension);
            ContentBody cbFile = new FileBody( file, mimeType);
            entity.addPart("title", cbFile);
