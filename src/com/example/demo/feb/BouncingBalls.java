...
public class BouncingBalls extends Activity {
    ...
    public static class MyAnimationView extends View {
        ...
        public MyAnimationView(Context context) {
            ...
            // Note that setting the backgroud color will automatically
            // invalidate the
            // view , so that the animated color, and the bouncing balls, get
            // redisplayed on
            // every frame of the animation.
            ObjectAnimator colorAnim = ObjectAnimator.ofInt(this, "backgroundColor", RED, GREEN,
                    BLUE);
