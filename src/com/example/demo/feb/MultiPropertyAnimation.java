...
public class MultiPropertyAnimation extends Activity {
    ...
    public static class MyAnimationView extends View implements AnimatorUpdateListener {
        ...
        private void createAnimation() {
            if (bounceAnim == null) {
                ShapeHolder ball;
                ball = balls.get(0);
                ObjectAnimator yBouncer = ObjectAnimator.ofFloat(ball, "y", ball.getY(),
                        getHeight() - BALL_SIZE).setDuration(DURATION);
                ...
                ObjectAnimator yAlphaBouncer = ObjectAnimator.ofPropertyValuesHolder(ball, pvhY,
                ...
                ObjectAnimator whxyBouncer = ObjectAnimator.ofPropertyValuesHolder(ball, pvhW,
                        pvhH, pvTX, pvTY).setDuration(DURATION / 2);
                ...
                Keyframe kf1 = Keyframe.ofFloat(0.5f, ballX + 100f);
